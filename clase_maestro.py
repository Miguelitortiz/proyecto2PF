...
class Maestro(clase_base.Base): 
    ...
    def generar_horario(self) -> list:
        ...
        '''
Genera y retorna el horario del maestro en forma de lista.

Retorna:
- list: Horario semanal del maestro.
...
'''
    ...
    def generar_horario_dia(self,dia:int) -> list:
        '''
Genera el horario del maestro para un día específico.

Parámetros:
- dia (int): Día de la semana (0 a 4).
